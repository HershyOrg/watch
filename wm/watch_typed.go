...
type WatchCallFunc[T any] func(varName string, getCallHandle GetNewUpdateFunc[T],
...
type GetNewUpdateFunc[T any] func(callCtx CallContext) (NewUpdateFunc func(runCtx RunContext) UpdateFunc[T], Err error)
