...
// WatchMachine은 백그라운드에서 WatchLoop를 돌리며 VarSig를 Manager(=Subscriber)로 보냄
type WatchFlowFunc[T any] func(varName string, getFlowHandle SetupUpdateFuncChan[T],
	managerCtx shared.ManageContext) (V shared.WatchValue[T])
...
type SetupUpdateFuncChan[T any] func(flowCtx FlowContext) (FlowChan chan UpdateFunc[T], Err error)
